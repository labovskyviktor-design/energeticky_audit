// ════════════════════════════════════════════════════════════════
// PROFESSIONAL MATERIAL DATABASE — STN 73 0540-3 (CZ/SK štandard)
// Properties: lambda [W/(m·K)], rho [kg/m³], c [J/(kg·K)], mu [-], default d [m]
// ════════════════════════════════════════════════════════════════
...
window.CONSTRUCTION_PRESETS = [
    {
        id: 'panel_original',
        label: 'Panelová stena ŽB — pôvodná',
        desc: 'ŽB panel hr. 150mm (zväčša pred 1990)',
        layers: [
            { name: 'Vápenocementová omietka',    lambda: 0.99, rho: 1800, c: 840,  mu: 15,  d: 0.015 },
            { name: 'ŽB stena panelová',          lambda: 1.58, rho: 2400, c: 1020, mu: 25,  d: 0.15  },
            { name: 'Vápenná omietka',            lambda: 0.88, rho: 1600, c: 840,  mu: 15,  d: 0.015 },
        ]
    },
    {
        id: 'panel_etics_eps',
        label: 'Panelová stena + ETICS (Polystyrén)',
        desc: 'Zateplená pôvodná panelová stena s 15cm EPS',
        layers: [
            { name: 'Silikónová omietka',         lambda: 0.70, rho: 1700, c: 840,  mu: 40,  d: 0.003 },
            { name: 'Lepiaca stierka (ETICS)',    lambda: 0.80, rho: 1500, c: 840,  mu: 20,  d: 0.005 },
            { name: 'EPS 70 F (fasádny)',         lambda: 0.039,rho: 15,  c: 1270, mu: 40,  d: 0.15  },
            { name: 'ŽB stena panelová',          lambda: 1.58, rho: 2400, c: 1020, mu: 25,  d: 0.15  },
            { name: 'Vápenná omietka',            lambda: 0.88, rho: 1600, c: 840,  mu: 15,  d: 0.015 },
        ]
    },
    {
        id: 'brick_original',
        label: 'Murovaná stena plná — pôvodná',
        desc: 'Tehla pálená (CPP) 450mm',
        layers: [
            { name: 'Cementová omietka',          lambda: 1.16, rho: 2000, c: 840,  mu: 19,  d: 0.02  },
            { name: 'Tehla pálená plná (CPP)',    lambda: 0.80, rho: 1800, c: 900,  mu: 9,   d: 0.45  },
            { name: 'Vápenná omietka',            lambda: 0.88, rho: 1600, c: 840,  mu: 15,  d: 0.015 },
        ]
    },
    {
        id: 'brick_etics_mw',
        label: 'Murovaná stena (CDm) + ETICS (Vata)',
        desc: 'Dutná tehla (CDm) + 15cm Minerálna vlna',
        layers: [
            { name: 'Silikónová omietka',         lambda: 0.70, rho: 1700, c: 840,  mu: 40,  d: 0.003 },
            { name: 'Lepiaca stierka (ETICS)',    lambda: 0.80, rho: 1500, c: 840,  mu: 20,  d: 0.005 },
            { name: 'Minerálna vlna fasádna',     lambda: 0.038,rho: 100, c: 840,  mu: 1.5, d: 0.15  },
            { name: 'Tehla dierovaná (CDm)',      lambda: 0.53, rho: 1450, c: 960,  mu: 8,   d: 0.38  },
            { name: 'Vápenná omietka',            lambda: 0.88, rho: 1600, c: 840,  mu: 15,  d: 0.015 },
        ]
    },
    {
        id: 'ytong_new',
        label: 'Moderný Porobetón (Ytong Lambda)',
        desc: 'Ytong Lambda YQ hrúbky 45cm bez zateplenia',
        layers: [
            { name: 'Lepiaca stierka (ETICS)',    lambda: 0.80, rho: 1500, c: 840,  mu: 20,  d: 0.005 },
            { name: 'Ytong Lambda YQ',            lambda: 0.08, rho: 300,  c: 1000, mu: 5,   d: 0.45  },
            { name: 'Sadrová omietka',            lambda: 0.57, rho: 1300, c: 840,  mu: 10,  d: 0.012 },
    ...
    {
        id: 'flat_roof_old',
        label: 'Plochá strecha betónová — pôvodná',
        desc: 'Železobetón + slabá vrstva pôvodnej vaty a IPA',
        layers: [
            { name: 'Asfaltový pás klasický (IPA)',   lambda: 0.21, rho: 1100, c: 1470, mu: 20000, d: 0.004 },
            { name: 'Minerálna vlna strešná',         lambda: 0.039,rho: 30, c: 840, mu: 1.2,      d: 0.05  },
            { name: 'Asfaltový pás klasický (IPA)',   lambda: 0.21, rho: 1100, c: 1470, mu: 20000, d: 0.004 },
            { name: 'Betónový poter',                 lambda: 1.23, rho: 2100, c: 1020, mu: 17,    d: 0.04  },
            { name: 'Železobetón (STN)',              lambda: 1.43, rho: 2300, c: 1020, mu: 23,    d: 0.20  },
            { name: 'Vápenná omietka',                lambda: 0.88, rho: 1600, c: 840,  mu: 15,    d: 0.015 },
        ]
    },
    {
        id: 'flat_roof_pir',
        label: 'Plochá strecha ľahká — po obnove',
        desc: 'ŽB strop doteplený PIR panelom',
        layers: [
            { name: 'PVC Hydroizolačná fólia (mPVC)', lambda: 0.16, rho: 1400, c: 1470, mu: 20000, d: 0.0015},
            { name: 'PIR pur doska',                  lambda: 0.022,rho: 32,  c: 1400, mu: 120,   d: 0.18  },
            { name: 'Asfaltový pás klasický (IPA)',   lambda: 0.21, rho: 1100, c: 1470, mu: 20000, d: 0.004 },
            { name: 'Železobetón (STN)',              lambda: 1.43, rho: 2300, c: 1020, mu: 23,    d: 0.20  },
        ]
    },
    {
        id: 'floor_on_ground_new',
        label: 'Nová podlaha na teréne',
        desc: 'Betón + 10cm EPS 150 + Poter',
        layers: [
            { name: 'Laminátová podlaha',             lambda: 0.14, rho: 600,  c: 1600, mu: 50,  d: 0.01  },
            { name: 'Betónový poter',                 lambda: 1.23, rho: 2100, c: 1020, mu: 17,  d: 0.05  },
            { name: 'Parozábrana PE fólia',           lambda: 0.35, rho: 950,  c: 1470, mu: 100000,d: 0.0002},
            { name: 'EPS 150 S (podlahový)',          lambda: 0.035,rho: 30,  c: 1270, mu: 50,  d: 0.10  },
            { name: 'Asfaltový pás klasický (IPA)',   lambda: 0.21, rho: 1100, c: 1470, mu: 20000, d: 0.004 },
            { name: 'Betón hutný (2200 kg/m³)',       lambda: 1.23, rho: 2200, c: 1020, mu: 17,  d: 0.15  },
        ]
    },
];

// ── Helper: get all materials as flat array ──────────────────────
window.getAllMaterials = function() {
    return Object.entries(window.MATERIALS).flatMap(([catId, cat]) =>
        cat.items.map(m => ({ ...m, category: catId, categoryLabel: cat.label }))
    );
};

console.log(`📦 Materials DB loaded: ${window.getAllMaterials().length} materials, ${Object.keys(window.MATERIALS).length} categories`);
